...
<div class="grid grid-cols-4 gap-x-40 gap-y-10 px-28 py-14 text-center">
    {{-- Contoh untuk beberapa negara --}}
    <button onclick="window.location.href='{{ route('pages.report-country', ['country' => 'Brunei Darussalam']) }}'"
        type="button"
        class="flex flex-col items-center justify-center border border-[#079D75] p-5 hover:bg-neutral-400 hover:text-white focus:z-10 rounded-lg">
        <img src="{{ asset('images/BRN.png') }}" alt="Brunei Darussalam" class="h-10 w-auto mb-2">
