...
<div class="grid grid-cols-2 gap-x-20 gap-y-10 mt-10 px-28 pb-5">
    <div>
...
<div class="text-right text-xs px-28 pb-7">
    <p>Source of data: The World Bank Group</p>
</div>

@if ($marineProtectedData->contains(function ($data) { return $data->polygon_data !== null; }))
<div class="text-center">
    <button onclick="window.location='{{ route('mpa.country', ['country' => $country]) }}'" class="bg-[#0F6FFF] mb-7 p-4 rounded-xl text-white">
