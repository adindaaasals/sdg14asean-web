  ...
  <div class="container mx-auto flex items-center justify-between p-2 md:p-5 lg:py-5">
    ...
    <div id="navbarSupportedContent" class="hidden lg:flex lg:items-center lg:w-auto">
      <ul class="flex flex-col gap-4 lg:ml-auto lg:flex-row" id="nav-items">
        <li class="nav-item">
          <a href="{{ route('pages.home') }}" class="text-[#2A3663] text-[16px] font-medium">Home</a>
        </li>
        <li class="nav-item">
          <a href="{{ route('pages.maps') }}" class="text-[#685C4F] text-[16px] font-medium">Visualization</a>
        </li>
        <li class="nav-item">
          <a href="{{ route('pages.report') }}" class="text-[#2A3663] text-[16px] font-medium">Report</a>
        </li>
      </ul>
    </div>
  </div>
